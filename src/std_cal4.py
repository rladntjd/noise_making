...
class Mission:
    def __init__(self):
        ...
        self.f = open('in_pl_4_50_6_filtered_std_data.txt', 'w')
        self.f2 = open('in_pl_4_50_6_filtered_std_data_pixel.txt', 'w')
        self.test_pub = rospy.Publisher('/testing_frequency', Int32, queue_size=10000)
        self.f3 = open('in_pl_4_50_6_filtered_mean_data_pixel.txt', 'w')
        self.f4 = open('in_pl_4_50_6_zero_value.txt', 'w')
        self.f5 = open('in_pl_4_50_6_over_value.txt', 'w')
        self.step = 3
